  ...
  <div class="block-info">
    <div class="q-container">
      ...
      <div class="row q-mt-lg justify-between" style="position: relative">
        <div class="block-title">Danh hợp công</div>
      </div>
      ...
      <q-dialog v-model="isPopupDeleteItem" persistent>
        <q-card style="width: 420px; height: auto; position: relative">
          ...
          <q-card-section class="row items-center">
            <q-space />
            <div class="title-del">Xóa dữ liệu bảng công</div>
            <q-space />
          </q-card-section>

          <q-card-section style="text-align: center"
            >Bạn muốn xóa dữ liệu bảng công đã chọn ?</q-card-section
          >
