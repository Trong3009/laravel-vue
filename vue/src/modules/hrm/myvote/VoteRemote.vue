            ...
            <q-form class="q-container id-card">
              <div class="form-group mb-10 form-title__overtime">
                <h3 class="text-grey-10 add__title">
                  {{ isEdit ? 'Thêm mới phiếu Remote' : 'Sửa phiếu remote' }}
                </h3>
              ...
              <div class="form-group mb-10 d-flex input-field">
                    <q-input outlined
                        :mask="mask"
                        v-model="remote.date_remote" type="date" :dense="true" class="input-field_info onsitedate" placeholder="dd/mm/yyyy">
                        <template v-slot:before>
                            <label style="font-size: 14px; color: #000;" for="">Ngày</label>
                        </template>
                    </q-input>
                    <q-input outlined v-model="remote.start_time" type="time" :dense="true" class="input-field_info">
                        <template v-slot:before>
                            <label style="font-size: 14px;" for="">Từ</label>
                        </template>
                    </q-input>
                    <q-input outlined v-model="remote.end_time" type="time" :dense="true" class="input-field_info">
                        <template v-slot:before>
                ...
                <div class="form-group mb-10 input-field">
                    ...
                    <q-input outlined v-model="remote.description" :dense="true" type="text" style="width: 80%;"></q-input>
                </div>
            ...
            <q-form class="q-container id-card">
              ...
              <div class="form-group mb-10 d-flex input-field">
                ...
                <div class="form-group mb-10 input-field">
                    ...
                    <q-select outlined v-model="remote.approved_by" :dense="true" style="width: 80%;"></q-select>
                </div>
                <div class="form-group mb-10 input-field">
                    <label for="">Người duyệt</label>
                    <q-input type="textarea" outlined v-model="remote.repair_remote" :dense="true" style="width: 80%;"></q-input>
                </div>
                <div class="form-group mb-10 ot-icon">
...
const columns = [
    {name: "date_remote",align: "left ",label: "Ngày",field: "date_remote",sortable: true,},
    {name: "name",align: "left",label: "Họ và tên",field: "name",sortable: true,},
    {
      name: "remote_time",align: "left",label: "Dự án",sortable: true,
      field: (row) => {
      if(isProxy(row)){
        row = toRaw(row);
    ...
    {name: "description",align: "left",label: "Mô tả",field: "description",sortable: true,},
...
const {
  remote,isError,isLoading,rows,pagination,getListData,createRemote,updateRemote,deleteDataItem,filter,selected,formatStatus,
} = useRemoteVote()
