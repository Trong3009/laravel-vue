  ...
  <div class="block-info">
    <div class="q-container">
      ...
      <div class="row q-mt-lg justify-between" style="position: relative">
        <div class="block-title">Danh sách mẫu bảng lương</div>
      ...
      <!-- Start: popup create salary sheets template  -->
      <q-dialog v-model="isPopupCreate" persistent>
        <q-card style="width: 1110px; height: 700px; max-width: 80vw">
          <q-card-section class="q-pb-none">
            <div class="q-container">
              <div class="form-group mb-10 pt-30 add-new_salary">
                <h3 class="text-grey-10 add__title">Thêm mới mẫu bảng lương</h3>
                <q-card-actions style="padding: 20px 0px">
                  <q-btn
                    style="background: #d9d9d9"
                    unelevated
                    label="Hủy bỏ"
              ...
              <div class="general-infor">
                ...
                <div class="general-select">
                  <div class="form_group d-flex mb-10 general">
                    <label for="">Tên mẫu bảng lương: </label>
                    <input type="text" id="" />
                  </div>
                  <div class="form_group d-flex mb-10 general">
                    <label for="">Đơn vị áp dụng: </label>
                    <select name="lang" id="lang-select">
                      <option value="dart" selected>Khoa Khúc xạ</option>
                      <option value="dart" selected>Khoa Lâm sàng</option>
                    </select>
                  </div>
                  <div class="form_group d-flex mb-10 general">
                    <label for="">Vị trí áp dụng: </label>
                    <select name="lang" id="lang-select">
                      <option value="dart" selected>Bác sĩ đa khoa</option>
                      <option value="dart" selected>Bác sĩ chuyên khoa</option>
                    </select>
                  </div>
                  <div class="form_group d-flex mb-10 general">
                    <label for="">Nhân viên áp dụng: </label>
                    <select name="lang" id="lang-select">
                      <option value="dart" selected>Đàm Vĩnh Hưng</option>
                      <option value="dart" selected>Hồ Ngọc Hà</option>
                    </select>
                  </div>
                </div>
              </div>
              <div class="salary-component" style="margin-top: 32px">
                <div class="salary-title">
                  <h3>Thành phần lương</h3>
                  <div class="preview">
      ...
      <!-- End: popup create salary sheets template -->

      <!-- Start: popup choose salary component -->
      <q-dialog v-model="isPopupChooseComponent" persistent>
        <q-card style="width: 1100px; max-width: 80vw">
          <q-card-section class="q-pb-none">
            <div
              class="row q-mt-lg justify-between popup-component"
              style="position: relative"
            >
              <div class="block-title">Danh sách mẫu bảng lương</div>
              <div class="btns-act q-gutter-x-md">
                <q-card-actions
                  class="button-add_component"
                  align="center"
                  style="padding: 20px 0px"
                >
                  <q-btn
                ...
                >
                  <q-item @click="handleDropdownItem1">
                    <q-item-section class="dropdown-action"
                      >Tải xuống</q-item-section
                    >
                  </q-item>
                  <q-item>
                    <q-item-section
      ...
      <!-- End: popup choose salary component -->
    </div>
  </div>
</template>
...
const isPopupChooseComponent = ref(false);
...
const handleChooseComponent = () => {
  isPopupChooseComponent.value = true;
};
